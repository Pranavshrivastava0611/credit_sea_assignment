...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 h-screen bg-dark-400/80 backdrop-blur-xl border-r border-white/[0.06] z-40 flex flex-col"
    >
      {/* Logo */}
        ...
        <AnimatePresence>
          {!collapsed && (
            ...
            >
              ...
              <span className="text-white font-semibold text-lg">CreditSea</span>
            </motion.div>
          )}
        </AnimatePresence>
        <button
